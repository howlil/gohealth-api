    ...
    apps: [
        {
            ...
            env: {
                ...
                FATSECRET_CLIENT_ID: process.env.FATSECRET_CLIENT_ID || 'your-fatsecret-client-id',
                FATSECRET_CLIENT_SECRET: process.env.FATSECRET_CLIENT_SECRET || 'your-fatsecret-client-secret',
